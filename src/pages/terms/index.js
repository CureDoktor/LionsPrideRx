...
export default function Terms(props) {
  return (
    <div className="container">
      ...
      <p>
        Welcome to lionspriderx.com (the &quot;Site&quot;), an Internet property
        owned and operated by Lions Pride USA LLC (&quot; lionspriderx.com
        ,&quot; &quot;we,&quot; &quot;our,&quot; or &quot;us&quot;). By
        accessing or using the Site, you agree to these LionsPrideRx.com Terms
        and Conditions (&quot;Terms and Conditions&quot;), which include the
        lionspirderx.com Privacy Policy (&quot;Privacy Policy&quot;), the
        Consent to Telehealth, the Frequently Asked Questions (&quot;FAQ&quot;),
        and all other applicable rules, policies, schedules, and terms and
        conditions or documents published from time to time (collectively, the
        &quot;Agreement&quot;).
      </p>
      <p>
        Provided you comply with these Terms and Conditions, we grant you a
        personal, limited, revocable, non-exclusive, and non-transferable right
        to use the Site and Services for personal and non-commercial use within
        the United States, as permitted under this Agreement, the Consent to
      ...
      <p>
        Third-Party Links are not under our control, and we are not responsible
        for their content or any updates made to them. We provide Third-Party
        Links for convenience, and inclusion of a link does not imply
        endorsement. Your use of Third-Party Links is at your own risk, and we
        are not liable for any content, errors, damage, or loss arising from or
      ...
      <p>
        ...
        evaluated the Content and Lionspriderx.com Products. The Content,
        ...
        or a substitute for it. Your physician&apos;s guidance and care should
      ...
      <p>
        ...
        the Lionspriderx.com Products will confirm to these specifications or
      ...
      <p>
        ...
        professional before utilizing any Lionspriderx.com Products,
        Prescription Medications, or adopting any treatment for a health
        problem, especially if you have medical conditions such as strokes, high
        blood pressure, heart, liver, kidney, or thyroid disease, diabetes, skin
        ...
        allow for proper follow-up visits and individualize your treatment plan
        as appropriate. If you have or suspect that you have a medical problem
        as a result of using any Lionspriderx.com Products, Prescription
      ...
      <p>
        ...
        consult with your physician or other healthcare professional before
        ...
        Medications to avoid potential allergic reactions. If you have or
      ...
      <p>
        ...
        (“Agreement”) between users and Lionspriderx.com governs the use of Site
      ...
      <p>
        ...
        Users must have compatible computer and/or mobile devices, access to the
        Internet, and certain necessary software to use the Platform. Any fees
        or charges incurred by your mobile service and Internet Service Provider
        in connection with your use of the Services are your sole
      ...
      <p>
        ...
        information and promptly advise Lionspriderx.com of any changes. Failure
        to do so entitles Lionspriderx.com to immediately terminate the use of
        certain Site Offerings that require registration. The information
      ...
      <p>
        ...
        applicable Form, providing the requisite Registration Data, completing
        ...
        subscription remains active. Users may cancel a subscription at any time
        up to forty-eight (48) hours before the applicable renewal processing
        date. In the One-Time Purchase option, the Payment Method provided on
        the Form will be charged the amount listed on the Site for the subject
        Product(s), plus shippin g and handling and any applicable sales tax.
        Users must promptly notify Lionspriderx.com if the Payment Method is
        cancelled or is no longer valid or the Product shipment may be delayed
        or cancelled.
      </p>
      <p>
        <b>5. Products :</b> The Products purchased from Lionspriderx.com are
      ...
      <p>
        ...
        health care services through electronic communications, information
        technology, or other means between a health care provider and a patient
        ...
        participating Healthcare Provider who will perform the requisite
        Telemedicine Services to determine your suitability for Prescription
        ...
        agree that Lionspriderx.com shall not be liable to you or any third
        ...
        Consent to Telehealth for a description of the risks and benefits of
      ...
      <p>
        ...
        to product reviews, text, audio, video, photographs, graphics, artwork,
        ...
        Content provided by Third-Party Providers that is made available through
        the Site Offerings. You should not necessarily rely on such Third-Party
        Content. Reliance on any Content or other information made available to
        you through the Site Offerings is solely at your own risk.
      ...
      <p>
        ...
        including textual, audio, and/or visual content, feedback related to the
        Services, vehicle repair quote requests, and competition entries. You
        retain ownership of any User Content you provide, but by submitting User
        Content to Lionspriderx.com , you grant Lionspriderx.com a worldwide,
        perpetual, irrevocable, transferrable, royalty-free license to use,
        copy, modify, create derivative works of, distribute, publicly display,
        publicly perform, and otherwise exploit the User Content in any manner,
        including on third-p arty sites and services. You represent and warrant
        that you own or have the necessary licenses and permissions to provide
        the User Content, and that it will not infringe on any third
        party&apos;s intellectual property or proprietary rights or violate any
        applicable law or regulation. Lionspriderx.com reserves the right to
      ...
      <p>
        ...
        Providers. If Lionspriderx.com is a business associate, it may be
      ...
      <p>
        ...
        warrants to Lionspriderx.com that (a) all information provided in
        ...
        and has not relied on any representation or warranty other than those
      ...
      <p>
        ...
        any trademark without Lionspriderx.com &apos;s express written consent
        ...
        consent. All Proprietary Content is protected under United States and
        foreign laws.
      </p>
      <p>
      ...
      <p>
        ...
        AND USING THE SITE OFFERINGS IS VOLUNTARY AND ENTIRELY AT THE
        USER&apos;S RISK. LIONSPRIDERX.COM , AS WELL AS ANY THIRD-PARTY OFFERING
        PRODUCTS OR SERVICES THROUGH THE SITE OFFERINGS, MAKE NO REPRESENTATIONS
        OR WARRANTIES OF ANY KIND, WHETHER EXPRESS OR IMPLIED, STATUTORY OR
        OTHERWISE, RELATED TO THIS AGREEMENT, THE SITE OFFERINGS, THE PRODUCTS
        ...
        BENEFIT OR OTHER HEALTH-RELATED OUTCOME. ADDITIONALLY, LIONSPRIDERX.COM
        DOES NOT GUARANTEE OR WARRANT THAT THE SITE OFFERINGS AND OTHER PRODUCTS
        AND SERVICES WILL BE FREE OF ERRORS, DISRUPTIONS, DELAYS, DEFECTS,
        ...
        LIONSPRIDERX.COM OR THE SITE OFFERINGS, WHETHER ORALLY OR IN WRITING,
      ...
      <p>
        ...
        IF ANY, FOR THE RIGHT TO ACCESS OR PARTICIPATE IN ANY ACTIVITY RELATED
        ...
        ANY THIRD-PARTY OFFERING PRODUCTS OR SERVICES THROUGH THE SERVICE. SOME
        JURISDICTIONS DO NOT ALLOW CERTAIN LIMITATIONS ON LIABILITY, AND IN SUCH
        JURISDICTIONS, THE LIABILITY OF LIONSPRIDERX.COM SHALL BE LIMITED TO THE
      ...
      <p>
        ...
        to copyrighted content or material available on the Site, you may submit
        a notification to our Designated Agent. Your notification under 17
        U.S.C. § 512(c) alleging copyright infringement must include the
      ...
      <p>
        <b>21. Dispute Resolution and Arbitration :</b> All claims that may
        ...
        Offerings, the terms and conditions of the Agreement, or the breach of
      ...
      <p>
        ...
        award shall be final and conclusive, and a judgment may be entered in
      ...
      <p>
        To the extent permitted by law, you agree not to bring, join, or
        ...
        arbitration or constitute an agreement. You may opt-out of these dispute
      ...
      <p>
        ...
        Users have the right to file grievances and complaints with the
        California Department of Consumer Affairs, 400 R Street, Ste. 1080,
        Sacramento, CA 95814; by phone at 916-445-1254 or 800-952-5210; or by
        email to dca@dca.ca.gov , as permitted by Cal. Civ. Code Sec. 1789.3.
      </p>
      <p>
        ...
        reproductive toxicity must carry warnings. The goal of these warnings is
        to help California consumers make informed choices about their exposure
        to such chemicals. The California Office of Environmental Health Hazard
        Assessment administers the program and maintains a list of more than 850
        chemicals that require warnings. New regulations were adopted by the
        OEHHA in August 2016, which became effective on August 30, 2018, and
        they change the information required in the warnings. We have included
        the following warning for products associated with this page: WARNING:
        Bisphenol A (BPA): Products may contain linings with Bisphenol A (BPA),
        a chemical known by the state of California to cause harm to the female
        reproductive system. Jar lids and bottle caps may also contain BPA. You
        can be exposed to BPA when you ingest products packaged in these
        containers. For more information, visit www.P65Warnings.ca.gov/BPA . For
        more information on Proposition 65 and its regulations, visit
        https://oehha.ca.gov/proposition -
        65/law/proposition-65-law-and-regulations . Additionally, for details on
        t he new warnings, visit https://www.p65warnings.ca.gov/new -
      ...
      <p>
        ...
        shall take precedence. The failure of Lionspriderx.com to enforce any
      ...
      <p>
        ...
        or partnership relationship between the parties or give either party the
      ...
      <p>
        ...
        Us&quot; page of the Site. You may also send us an email at
        support@lionspriderx.com .com , call us at 888-802-9541 , or send us
        U.S. mail to Lions Pride USA LLC (d/b/a Lionspriderx.com ), 1178
        Broadway 3rd Floor,New York, NY, 10001
      </p>
      <p>
